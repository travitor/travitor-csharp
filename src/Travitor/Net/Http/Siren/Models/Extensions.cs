...
namespace Travitor.Net.Http.Siren.Models {
    public static partial class Extensions {
        //public static Actions Add(this Actions self, string name, string title, HttpMethod method, Href href, string type = "application/x-www-form-urlencoded", IEnumerable<Field> fields = null) {
        //    return Add(self, name, title, method.Method, href, type, fields);
        //}
        ...
        //public static IActionBuilder Method(this IActionBuilder self, HttpMethod value) {
